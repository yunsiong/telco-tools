...
def main() -> None:
    ...
    class TracerApplication(ConsoleApplication, UI):
        ...
        def on_script_created(self, script: telco.core.Script) -> None:
...
class Tracer:
    ...
    def start_trace(self, session: telco.core.Session, stage, parameters, runtime, ui) -> None:
...
class Repository:
    ...
    def _create_stub_native_handler(self, target: TraceTarget, decorate: bool) -> str:
        ...
        return """\
/*
 * Auto-generated by Telco. Please modify to match the signature of %(display_name)s.
 * This stub is currently auto-generated from manpages when available.
 *
 * For full API reference, see: https://telco.re/docs/javascript-api/
 */
...
class FileRepository(Repository):
    ...
    def _ensure_monitor(self, handler_file) -> None:
        ...
        if monitor is None:
            monitor = telco.FileMonitor(handler_dir)
